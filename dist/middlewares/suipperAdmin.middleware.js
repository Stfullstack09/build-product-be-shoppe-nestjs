...
exports.SupperAdminMiddleware = void 0;
const common_1 = require("@nestjs/common");
const jwt_1 = require("@nestjs/jwt");
const lodash_1 = require("lodash");
const Respone_1 = require("../helpers/Respone");
const enum_1 = require("../utils/enum");
let SupperAdminMiddleware = class SupperAdminMiddleware {
    ...
    async use(req, res, next) {
        ...
        if (req && !(0, lodash_1.isEmpty)(req.cookies)) {
            ...
            try {
                ...
                if (checkAccessToken.role === enum_1.EntitiesEnum.role_supper_admin && checkAccessToken.isSuperAdmin) {
...
exports.SupperAdminMiddleware = SupperAdminMiddleware;
exports.SupperAdminMiddleware = SupperAdminMiddleware = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [jwt_1.JwtService])
], SupperAdminMiddleware);
//# sourceMappingURL=suipperAdmin.middleware.js.map